...
INSERT INTO customers (id, company, last_name, first_name, email_address, job_title, business_phone, home_phone, mobile_phone, fax_number, address, city, state_province, zip_postal_code, country_region, web_page, notes, attachments) VALUES (30, 'Company CC', 'Didi', 'Jane', NULL, 'Owner', '(123)555-0100', NULL, NULL, '(123)555-0101', '789 30th Street', 'New York', 'NY', '99999', 'USA', NULL, NULL, '');
-- 29 records
...
INSERT INTO sales_reports (group_by, display, title, filter_row_source, default_) VALUES ('Category', 'Category', 'Sales By Category', 'SELECT DISTINCT [Category] FROM [products] ORDER BY [Category];', 0);
INSERT INTO sales_reports (group_by, display, title, filter_row_source, default_) VALUES ('country_region', 'Country/Region', 'Sales By Country', 'SELECT DISTINCT [country_region] FROM [customers Extended] ORDER BY [country_region];', 0);
INSERT INTO sales_reports (group_by, display, title, filter_row_source, default_) VALUES ('Customer ID', 'Customer', 'Sales By Customer', 'SELECT DISTINCT [Company] FROM [customers Extended] ORDER BY [Company];', 0);
INSERT INTO sales_reports (group_by, display, title, filter_row_source, default_) VALUES ('employee_id', 'Employee', 'Sales By Employee', 'SELECT DISTINCT [Employee Name] FROM [employees Extended] ORDER BY [Employee Name];', 0);
INSERT INTO sales_reports (group_by, display, title, filter_row_source, default_) VALUES ('Product ID', 'Product', 'Sales by Product', 'SELECT DISTINCT [Product Name] FROM [products] ORDER BY [Product Name];', 1);
-- 5 records
